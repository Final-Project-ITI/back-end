...
const menuCategoryRouter = (
    ...
    async (req, res, next) => {
      try {
        const menuCategories =
          await menuCategoryController.getRestaurantMenuCategories(
  ...
  router.get("/:resId", async (req, res, next) => {
    try {
      const menuCategories =
        await menuCategoryController.getRestaurantMenuCategories(
          req.params.resId
  ...
  router.get(
    ...
    async (req, res, next) => {
      try {
        const menuCategory =
          await menuCategoryController.getRestaurantMenuCategoryById(
            req.auth.restaurantId,
    ...
    async (req, res, next) => {
      try {
        const newMenuCategory =
          await menuCategoryController.createRestaurantMenuCategory(
            req.auth.restaurantId,
            req.body.name,
            req.file
          );
    ...
    async (req, res, next) => {
      try {
        const updatedCategory =
          await menuCategoryController.updateRestaurantMenuCategoryById(
            req.auth.restaurantId,
            req.params.menuCategoryId,
            req.body,
            req.file
    ...
    async (req, res, next) => {
      try {
        const deletedMenuCategory =
          await menuCategoryController.deleteRestaurantMenuCategory(
            req.auth.restaurantId,
            req.params.menuCategoryId
          );
