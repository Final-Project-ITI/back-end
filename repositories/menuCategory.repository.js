...
class CategoryRepository {
  ...
  async getRestaurantMenuCategoryById(restaurantId, _id) {
    return await MenuCategoryModel.findOne({
      _id,
  ...
  async updateRestaurantMenuCategoryById(restaurantId, _id, val) {
    return await MenuCategoryModel.updateMany(
      { _id, restaurantId: new ObjectId(restaurantId) },
      val
    );
  }
  ...
  async deleteRestaurantMenuCategory(restaurantId, _id) {
    return await MenuCategoryModel.deleteOne({
      _id,
      restaurantId: new ObjectId(restaurantId),
    });
  }
