...
class RestaurantService {
    restaurants = [
        {
            ...
            description: "Experience a fusion of flavors from around the world at Cuisine Central."
        },
        {
            id: 2,
            name: "Pizza Palace",
        ...
        },
        {
            ...
            description: "Satisfy your cravings with our delicious tacos and burritos."
        },
        {
            id: 7,
            name: "BBQ Bonanza",
        ...
        },
        {
            ...
            description: "Delight in our flavorful vegetarian dishes, fresh and healthy."
        },
        {
            id: 9,
            ...
            description: "Dive into a world of seafood delights at Seafood Sensation."
        },
        {
            id: 10,
            name: "Dessert Dreams",
    ...
    getRestaurantsByName(name) {
        const restaurants = this.restaurants.filter((res) => res.name.toLowerCase().includes(name));
