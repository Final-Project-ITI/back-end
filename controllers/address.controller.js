...
class AddressController {
  ...
  async createUserAddress(userId, details) {
    ...
    const isAddressExist = addresses.find(
  ...
  async updateUserAddressById(userId, addressId, { details }) {
    ...
    const phone = await this.addressRepository.getUserAddressById(
      userId,
      addressId
    );
    ...
    return await this.addressRepository.updateUserAddressById(
      userId,
      addressId,
      { details }
    );
